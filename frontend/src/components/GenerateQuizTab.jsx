        ...
        <div className="space-y-4">
            ...
            <div className="text-right">
              ...
              <div className="mt-1">
                {(result.related_topics || []).slice(0, 6).map((t, i) => (
                  <span
                    key={i}
                    className="inline-block bg-gray-100 px-2 py-1 text-xs mr-1 rounded"
                  >
                    {t}
                  </span>
                ))}
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`px-3 py-1 rounded ${!takeMode ? 'bg-blue-600 text-white' : 'border'}`}
            >
              View
            </button>
                      ...
                      q.options.map((o, i) => (
                        <label
                          ...
                          className={`p-2 border rounded cursor-pointer ${
                            takeMode && answers[idx] === o ? 'bg-blue-50 border-blue-300' : ''
                          }`}
                        >
                          {takeMode && (
                            <input
